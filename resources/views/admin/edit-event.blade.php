...
<body class="bg-black text-white">
    <div class="text-center mt-3">
        ...
        <p class="text-[#FF914D] text-[85px] leading-none font-ibm font-black tracking-[0.15em]">EDIT EVENT</p>
    </div>
    <div
        class="w-[1100px] h-[400px] rounded-[17px] border-2 bg-white mx-auto mt-4 flex justify-center items-center font-saira">
        <div class="w-[92%] h-[87%]">
            <form action=" {{ route('eventupdate', ['id' => $admins->id, 'isSuccess' => 'Data tersimpan']) }}" method="post">
            @csrf
            @method('PUT')
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px]">
                    ...
                    <div class="w-[100%] h-[38px] text-center text-black flex justify-center items-center">
                        <input type="text" name="nama" class= "w-[100%] tracking-[0.08em] font-normal" value="{{ $admins->nama }}">
                    </div>
                </div>
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px] mt-1">
                    <div class="flex w-[100%]">
                        <div class="flex w-[50%]">
                            ...
                            <div class="w-[100%] h-[38px] text-center text-black flex justify-left items-center">
                                <input type="date" name="tanggal_dibuat" value="{{ $admins->tanggal_dibuat }}" class="ml-[4px] w-[130px] tracking-[0.08em] uppercase font-normal">
                            </div>
                        </div>
                        <div class="flex w-[50%]">
                            <div class="w-[220px] text-[#22263E] flex items-center">
                            ...
                            <div class="w-[100%] h-[38px] text-center text-black flex justify-left items-center">
                                <input type="date" name="tanggal_kadaluarsa" value="{{ $admins->tanggal_dibuat }}" class="w-[130px] tracking-[0.08em] uppercase font-normal">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px] mt-1">
                    ...
                    <div class="w-[100%] h-[38px] text-center text-black flex justify-center items-center">
                        <input type="text" name="nama_perusahaan" class= "w-[100%] tracking-[0.08em] font-normal" value="{{ $admins->nama_perusahaan }}">
                    </div>
                </div>
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px] mt-1">
                    <div class="w-[220px] text-[#22263E] flex items-center">
                    ...
                    <div class="w-[100%] h-[38px] text-center text-black flex justify-center items-center">
                        <input type="text" name="total_peserta" class= "w-[100%] tracking-[0.08em] font-normal" value="{{ $admins->total_peserta }}">
                    </div>
                </div>
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px] mt-1">
                    <div class="w-[220px] text-[#22263E] flex items-center">
                    ...
                    <div class="w-[100%] h-[38px] text-center text-black flex justify-center items-center">
                        <input type="text" name="lokasi_event" class= "w-[100%] tracking-[0.08em] font-normal" value="{{ $admins->lokasi_event }}">
                    </div>
                </div>
                <div class="flex justify-normal font-black leading-none tracking-[0.08em] text-[18px] mt-1">
                    ...
                    <div class="w-[228px] h-[38px] text-center text-black flex items-center">
                        ...
                        @endfor
                        <input id="passInput" name="passcode" value="{{ $admins->passcode }}" type="text" class="absolute w-[220px] h-[30px] opacity-0"
                            inputmode="numeric"
                            onkeyup="
                    ...
                    <div class="w-[100%] h-[38px] text-center text-black flex items-center">
                        <div class="flex items-center w-[400px] h-[30px]">
                            <div class="flex w-[50%] h-[100%] font-normal items-center">
                                ...
                                <input id="teamsix2" type="radio" name="teamsix" value="2" @if($admins->teamsix == 2) checked @endif class="w-[20px] h-[20px]">
                            </div>
                            <div class="flex w-[50%] h-[100%] font-normal items-center">
                                <label for="teamsix3" class="mr-[10px] select-none">TEAM SIX 3</label> 
                                <input id="teamsix3" type="radio" name="teamsix" value="3" @if($admins->teamsix == 3) checked @endif class="w-[20px] h-[20px]">
                            </div>
                        </div>
                    </div>
                </div>
                <div id="successYes" class="w-[135px] flex justify-center items-center mt-[18px] text-[#A02B2D] text-[12.4px] font-black tracking-[0.04em]">
                    <p>{{ isset($isSuccess) ? $isSuccess : '' }}</p>
                </div>
